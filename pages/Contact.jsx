                    ...
                    <div className="col-lg-4">
                        <div className="d-flex flex-column align-items-center bg-dark rounded text-center py-5 px-3">
                            <div className="bg-primary rounded-circle d-flex align-items-center justify-content-center mb-3" style={{ width: '60px', height: '60px' }}>
                                <FontAwesomeIcon icon={faMapMarkerAlt} className="fs-4 text-white" />
                            </div>
                ...
                <div className="row g-0">
                    ...
                    <div className="col-lg-6">
                        <iframe className="w-100"
                            ...
                            frameBorder="0" style={{ height: '457px', border: '0' }} allowFullScreen="" aria-hidden="false" tabIndex="0"></iframe>
                    </div>
                </div>
            </div>
            <Footer />
